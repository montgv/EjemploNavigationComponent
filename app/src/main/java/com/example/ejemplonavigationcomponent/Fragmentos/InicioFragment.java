...
import com.example.ejemplonavigationcomponent.databinding.FragmentInicioBinding;
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (edit1.getText().toString().isEmpty() || edit2.getText().toString().isEmpty()) {
                    Toast.makeText(getContext(), "Debes introducir algún valor en todos los campos",
